...
import { CustomRoute, CustomRoutes } from '../../enums/CustomRoutes';
...
const AuthenticatedAppRouter: FunctionComponent = () => {
  ...
  return (
    <Routes>
      ...
      <Route element={<DynamicCustomRouter route={CustomRoutes.REPORT} />} path={ROUTES.CUSTOM_REPORT} />
      <Route element={<DynamicCustomRouter route={CustomRoutes.UPLOAD} />} path={ROUTES.CUSTOM_UPLOAD} />
