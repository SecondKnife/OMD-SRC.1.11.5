...
import { ByRulesTab, ByTablesTab, ResultsTab } from './DataQualityIframeTabs';
...
class DataQualityClassBase {
  ...
  public getDataQualityTab() {
    return [
      ...
      {
        key: DataQualityPageTabs.RULES,
        component: ByRulesTab,
        label: i18n.t('label.by-entity', {
          entity: i18n.t('label.rule-plural'),
        }),
      },
      {
        key: DataQualityPageTabs.RESULTS,
        component: ResultsTab,
        label: i18n.t('label.result-plural'),
      },
    ];
  }
