...
export const SIDEBAR_LIST: Array<LeftSidebarItem> = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        key: ROUTES.CUSTOM_REPORT,
        title: 'label.report',
        redirect_url: ROUTES.CUSTOM_REPORT,
        icon: InsightsIcon,
        dataTestId: `app-bar-item-report`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    icon: ClassificationIcon,
    dataTestId: 'custom-feature',
    children: [
      {
        key: ROUTES.CUSTOM_UPLOAD,
        title: 'label.upload',
        redirect_url: ROUTES.CUSTOM_UPLOAD,
        icon: DataQualityIcon,
        dataTestId: `app-bar-item-upload`,
      }
    ],
  },
];
